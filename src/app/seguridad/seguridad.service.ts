...
export class SeguridadService {
  ...
  guardarToken(repuestaAutenticacion: RespuestaAutenticacionDTO){
    localStorage.setItem(this.llaveToken, repuestaAutenticacion.token);
    localStorage.setItem(this.llaveExpiracion, repuestaAutenticacion.expiracion.toString());
  }
